...
build_image() {
  name=$1
  replaced=${name/\//"-"}
  docker buildx build --pull --platform=linux/$1 --tag=philiplehmann/mailcatcher:v0.9.0-$replaced .
  docker tag philiplehmann/mailcatcher:v0.9.0-$replaced philiplehmann/mailcatcher:latest-$replaced
}
...
deploy_image() {
  ...
  docker push philiplehmann/mailcatcher:v0.9.0-$replaced
}
export -f deploy_image

parallel -kj6 deploy_image ::: amd64 arm/v5 arm/v7 arm64/v8 mips64le ppc64le s390x

docker manifest create --amend philiplehmann/mailcatcher:v0.9.0 \
                               philiplehmann/mailcatcher:v0.9.0-amd64 \
                               philiplehmann/mailcatcher:v0.9.0-arm-v5 \
                               philiplehmann/mailcatcher:v0.9.0-arm-v7 \
                               philiplehmann/mailcatcher:v0.9.0-arm64-v8 \
                               philiplehmann/mailcatcher:v0.9.0-mips64le \
                               philiplehmann/mailcatcher:v0.9.0-ppc64le \
                               philiplehmann/mailcatcher:v0.9.0-s390x

docker manifest push philiplehmann/mailcatcher:v0.9.0
